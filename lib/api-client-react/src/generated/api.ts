...
export const generatePrompt = async (
  ...
  return customFetch<GeneratePromptResponse>(getGeneratePromptUrl(), {
    ...
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(generatePromptRequest),
  });
};
 ...
 */
export const getListPromptsUrl = (projectId: number) => {
  return `/api/prompts/${projectId}`;
};
...
export const listPrompts = async (
  ...
  return customFetch<GeneratedPrompt[]>(getListPromptsUrl(projectId), {
    ...options,
    method: "GET",
  });
};

export const getListPromptsQueryKey = (projectId: number) => {
  return [`/api/prompts/${projectId}`] as const;
};
...
>(
  ...
  const queryKey = queryOptions?.queryKey ?? getListPromptsQueryKey(projectId);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof listPrompts>>> = ({
    signal,
  }) => listPrompts(projectId, { signal, ...requestOptions });
...
>(
  ...
  const queryOptions = getListPromptsQueryOptions(projectId, options);
 ...
 */
export const getGetPromptUrl = (
  projectId: number,
  moduleId: number,
  submoduleId: string,
) => {
  return `/api/prompts/${projectId}/${moduleId}/${submoduleId}`;
};
...
export const getPrompt = async (
  ...
  return customFetch<GeneratedPrompt>(
    getGetPromptUrl(projectId, moduleId, submoduleId),
    {
      ...options,
      method: "GET",
    },
...
export const getGetPromptQueryKey = (
  projectId: number,
  moduleId: number,
  submoduleId: string,
) => {
  return [`/api/prompts/${projectId}/${moduleId}/${submoduleId}`] as const;
};
...
>(
  ...
  const queryKey =
    ...
    getGetPromptQueryKey(projectId, moduleId, submoduleId);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getPrompt>>> = ({
    signal,
  }) =>
    getPrompt(projectId, moduleId, submoduleId, { signal, ...requestOptions });
...
>(
  ...
  const queryOptions = getGetPromptQueryOptions(
    projectId,
    moduleId,
    submoduleId,
    options,
